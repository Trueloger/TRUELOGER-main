...
export function QuickServices() {
  return (
    <section aria-labelledby="quick-services-heading" className="relative">
      {/* Curve block: no background of its own, so its SVG's transparent
          area correctly reveals the hero (the earlier sibling) behind it —
          not a same-element background that would just repaint ivory. */}
      <HeroToServicesCurve />
